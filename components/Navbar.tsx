...
import { LayoutDashboard, PlaySquare, LogIn, LogOut, Users, BarChart3, Info, Share2, Instagram } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex gap-2 items-center">
            ...
            <button
               ...
               className="ml-2 bg-gradient-to-tr from-yellow-500 via-orange-500 to-purple-600 text-white p-2 rounded-lg hover:opacity-90 transition-opacity shadow-lg"
